...
export const customHideProperties = (values: DatagridPreviewProps,
    ...
    if (values.remotePaging) {
        ...
        if (!values.pagingAction){
            hidePropertyIn(defaultProperties, values, "pagingActionControlsDataReload");
        }
    } else {
        hidePropertiesIn(defaultProperties, values, ["pagingAction","pagingActionControlsDataReload", "pagingDisplayType", "pagingTotalCount", "pageNumber", "pageSizeAttribute"])
    }
    ...
    if (values.sortingType === "remote") {
        ...
        if (!values.onSortChangedAction){
            hidePropertyIn(defaultProperties, values, "onSortActionControlsDataReload");
        }
        ...
        hidePropertiesIn(defaultProperties, values, ["sortAttribute", "onSortActionControlsDataReload", "sortAscending", "onSortChangedAction", "executeSortChangedActionOnStartup"])
    }
